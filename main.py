...
class Game:
    def __init__(self):
        ...
        self.state = "menu"
        self.title_font = pygame.font.Font("data/fonts/PressStart2P-Regular.ttf", 40)
        self.button_font = pygame.font.Font("data/fonts/PressStart2P-Regular.ttf", 24)
    ...
    def main_menu(self):
        ...
        button_w = self.screen.get_width() * 0.3
        button_h  =self.screen.get_height() * 0.1

        start_button = pygame.Rect(self.screen.get_width()/2 - button_w/2, self.screen.get_height()/2, button_w, button_h)
        exit_button = pygame.Rect(self.screen.get_width()/2 - button_w/2, self.screen.get_height()/2 + button_h + 20, button_w, button_h)

        self.screen.fill((99,155,255))

        
        title = self.title_font.render("Manaless Mage", True, (255,255,255))
        ...
        self.screen.blit(start_text,(start_button.centerx - start_text.get_width()/2, start_button.centery - start_text.get_height()/2))
        ...
        if exit_button.collidepoint((mx,my)) and pygame.mouse.get_pressed()[0]:
            pygame.quit()
            sys.exit()
